...
import com.charlie.app.domain.Employee;
import com.charlie.app.repository.EmployeeRepository;
...
import com.charlie.app.service.dto.EmployeeDTO;
import com.charlie.app.service.mapper.EmployeeMapper;
...
public class EmployeeResource {
    ...
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(Pageable pageable) {
        ...
        Page<EmployeeDTO> page = employeeRepository.findAll(pageable).map(employeeMapper::toDto);
